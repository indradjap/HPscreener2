...
required = [
    'app.py','dashboard.py','market_overview.py','smart_money.py','stock_pick.py','hplp_lab.py','idx_official.py','ui.py','style.css',
...
print('Menus: Dashboard, Market Overview, Smart Money Screener, Stock Pick, HPLP Lab')
